...
_lr_productions = [
  ...
  ('exp -> FLOAT','exp',1,'p_exp_float','parser.py',127),
  ('exp -> IDENTIFIER','exp',1,'p_exp_id','parser.py',131),
  ('exp -> exp SUM exp','exp',3,'p_exp_operator','parser.py',135),
  ('exp -> exp SUB exp','exp',3,'p_exp_operator','parser.py',136),
  ('exp -> exp MUL exp','exp',3,'p_exp_operator','parser.py',137),
  ('exp -> exp DIV exp','exp',3,'p_exp_operator','parser.py',138),
  ('exp -> SUB exp','exp',2,'p_exp_operator','parser.py',139),
  ('exp -> exp MOD exp','exp',3,'p_exp_operator','parser.py',140),
  ('exp -> exp LT exp','exp',3,'p_exp_operator','parser.py',141),
  ('exp -> exp LTE exp','exp',3,'p_exp_operator','parser.py',142),
  ('exp -> exp EQUAL exp','exp',3,'p_exp_operator','parser.py',143),
  ('exp -> exp NOTEQ exp','exp',3,'p_exp_operator','parser.py',144),
  ('exp -> exp GT exp','exp',3,'p_exp_operator','parser.py',145),
  ('exp -> exp GTE exp','exp',3,'p_exp_operator','parser.py',146),
  ('exp -> exp AND exp','exp',3,'p_exp_operator','parser.py',147),
  ('exp -> exp OR exp','exp',3,'p_exp_operator','parser.py',148),
  ('exp -> NOT exp','exp',2,'p_exp_operator','parser.py',149),
  ('exp -> LRB exp RRB','exp',3,'p_exp_operator','parser.py',150),
]
